   ...
   extends ContentPane
{
   ...
   protected void init()
   {
      ...
      EventHandler<ActionEvent> upgradeEvent =
         new PanelChangeEvent(mFossilUpgradesPane);
      ...
      EventHandler<ActionEvent> applyEvent =
         new EventHandler<ActionEvent>()
         {
            ...
            {
               mModel.getEnergyManager().getFossil()
   ...
   protected void update()
   {
      ...
      mValues.get("Supply Provided")
            ...
            mModel.getEnergyManager().getFossil().getPower()));
      mValues.get("Cost")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getFossil().getCostBuild()));
      mValues.get("Public Approval")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getFossil().getApproval()));
      mValues.get("Emissions")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getFossil().getEmissions()));
      mValues.get("Security")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getFossil().getSecurity()));
      mValues.get("Profit")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getFossil().getProfit()));
   }
