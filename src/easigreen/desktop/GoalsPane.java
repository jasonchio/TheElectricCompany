   ...
   extends ContentPane
{
   ...
   protected static String[] mLabelNames =
      new String[]
      {
         "Power Demand", "Power Supply", "Budget", "Total Spent",
         "Minimum Approval", "Public Approval", "Target Emissions",
         "Total Emissions", "Target Security", "Total Security", "Target Profit",
         "Total Profit"
      };
   ...
   protected int[] getRows()
   {
      return new int[]
      {
         10, 6, 5, 5, 1, 5, 5, 1, 5, 5, 4, 6, 5, 5, 1, 5, 5, 1, 5, 5, 10
      };
   }
