   ...
   extends ContentPane
{
   ...
   protected static String[] mLabelNames =
      new String[]
      {
         "Nuclear Science", "Fossil Fuel Science", "Renewable Science",
         "Oil Science", "Nuclear Engineering", "Fossil Fuel Engineering",
         "Renewable Engineering", "Price Change", "Lobby", "Oil Drilling"
      };
   ...
   {
      mValues.get("Nuclear Science")
             .setText("" + mModel.getUpgradeManager().getNuclearScience());
      mValues.get("Fossil Fuel Science")
             .setText("" + mModel.getUpgradeManager().getFossilScience());
      mValues.get("Renewable Science")
             .setText("" + mModel.getUpgradeManager().getRenewableScience());
      mValues.get("Oil Science")
             .setText("" + mModel.getUpgradeManager().getOilScience());
      mValues.get("Nuclear Engineering")
             .setText("" + mModel.getUpgradeManager().getNuclearEngineering());
      mValues.get("Fossil Fuel Engineering")
             .setText("" + mModel.getUpgradeManager().getFossilEngineering());
      mValues.get("Renewable Engineering")
             .setText("" +
         mModel.getUpgradeManager().getRenewableEngineering());
      mValues.get("Price Change")
             .setText("" + mModel.getUpgradeManager().getPriceChange());
      mValues.get("Lobby").setText("" + mModel.getUpgradeManager().getLobby());
      mValues.get("Oil Drilling")
             .setText("" + mModel.getUpgradeManager().getOilDrilling());
      mTechList.update();
   }
