...
public class TechnologyManager
{
   ...
   private void setPlantLists()
   {
      for (Technology t : mAll)
      {
         ...
         if ((t.getNuclear().getPower() > 0) || (t.getNuclear().getCost() < 0) ||
         ...
         if ((t.getFossil().getPower() > 0) || (t.getFossil().getCost() < 0) ||
         ...
         if ((t.getOil().getConsumption() < 0) ||
                (t.getOil().getSecurity() > 0) || (t.getOil().getGrowth() < 0))
         {
            mOil.add(t);
         }
      }
   ...
   public UpgradeMerger update()
   {
      ...
      for (int i = 0; i < mImplemented.size(); i++)
      {
         ...
         allChanges.addDemandRateChange(mImplemented.get(i).getOther()
                                                    .getDemand());
         allChanges.addEmissionsChange(mImplemented.get(i).getOther()
                                                   .getEmissions());
         // Nuclear
         ...
         allChanges.addNuclearApproval(mImplemented.get(i).getNuclear()
                                                   .getApproval());
         allChanges.addNuclearEmissions(mImplemented.get(i).getNuclear()
                                                    .getEmissions());
         allChanges.addNuclearSecurity(mImplemented.get(i).getNuclear()
                                                   .getSecurity());
         ...
         allChanges.addFossilApproval(mImplemented.get(i).getFossil()
                                                  .getApproval());
         allChanges.addFossilEmissions(mImplemented.get(i).getFossil()
                                                   .getEmissions());
         allChanges.addFossilSecurity(mImplemented.get(i).getFossil()
                                                  .getSecurity());
         allChanges.addFossilProfit(mImplemented.get(i).getFossil().getProfit());
         // Renewable
         allChanges.addRenewablePower(mImplemented.get(i).getRenewable()
                                                  .getPower());
         allChanges.addRenewableCost(mImplemented.get(i).getRenewable().getCost());
         allChanges.addRenewableApproval(mImplemented.get(i).getRenewable()
                                                     .getApproval());
         allChanges.addRenewableEmissions(mImplemented.get(i).getRenewable()
                                                      .getEmissions());
         allChanges.addRenewableSecurity(mImplemented.get(i).getRenewable()
                                                     .getSecurity());
         allChanges.addRenewableProfit(mImplemented.get(i).getRenewable()
                                                   .getProfit());
         // Oil
         allChanges.addOilConsumption(mImplemented.get(i).getOil()
                                                  .getConsumption());
