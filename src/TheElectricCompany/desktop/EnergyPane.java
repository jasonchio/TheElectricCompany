   ...
   extends ContentPane
{
    ...
    */
   protected static String[] mMainLabelNames =
      new String[]{ "Energy Demand", "Energy Supplied" };

   /**
    * Holds subsequent labels for this pane
    */
   protected static String[] mSubLabelNames =
      new String[]
      {
         "Nuclear Plants", "Nuclear Energy", "Fossil Fuel Plants",
         "Fossil Fuel Energy", "Renewable Plants", "Renewable Energy"
      };
    ...
    */
   protected static String mOilLabel =
      new String("Millions of Barrels per Day");
   ...
   {
      mPieChartData = FXCollections.observableArrayList(new PieChart.Data(
               "Nuclear", 34), new PieChart.Data("Fossil Fuels", 33),
   ...
   protected void update()
   {
      ...
      double nuclearEnergy =
         mModel.getEnergyManager().getNuclear().getTotalPower();
      double fossilEnergy =
         mModel.getEnergyManager().getFossil().getTotalPower();
      double renewableEnergy =
         mModel.getEnergyManager().getRenewable().getTotalPower();
      ...
      mValues.get("Energy Supplied")
             .setText(String.format(FORMAT, energySupplied));
      ...
      mValues.get("Fossil Fuel Energy")
             .setText(String.format(FORMAT, fossilEnergy));
      mValues.get("Renewable Plants").setText("" + renewablePlants);
      mValues.get("Renewable Energy")
             .setText(String.format(FORMAT, renewableEnergy));
      mValues.get(mOilLabel).setText(String.format(FORMAT, oil));

      mPieChartData.setAll(new PieChart.Data("Nuclear",
            (nuclearEnergy / energySupplied)),
