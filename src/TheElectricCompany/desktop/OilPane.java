   ...
   extends ContentPane
{
   ...
   protected static String[] mLabelNames =
      new String[]
      {
         "Oil Consumption", "Total Oil Emissions",
         "Oil Security per Million Barrels", "Total Oil Security"
      };
   ...
   protected void init()
   {
      ...
      EventHandler<ActionEvent> upgradeEvent =
         new PanelChangeEvent(mOilUpgradesPane);
   ...
   protected void update()
   {
      ...
      mValues.get("Oil Consumption")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getOil().getConsumption()));
      mValues.get("Total Oil Emissions")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getOil().getEmissions()));
      mValues.get("Oil Security per Million Barrels")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getOil().getSecurity()));
      mValues.get("Total Oil Security")
             .setText(String.format(FORMAT,
            mModel.getEnergyManager().getOil().getTotalSecurity()));
   }
