      ...
      mActionButton.setOnAction(new EventHandler<ActionEvent>()
         {
            public void handle(ActionEvent event)
            {
               mModel.getUpgradeManager()
                     .addFossilScience(mFossilSci.getChange());
               mModel.getResourceManager()
                     .spendActionPoints(Math.abs(mFossilSci.getChange()));
               mModel.getUpgradeManager()
                     .addFossilEngineering(mFossilEng.getChange());
               mModel.getResourceManager()
                     .spendActionPoints(Math.abs(mFossilEng.getChange()));
